...
#      echo $save_score_file
      ...
      save_score_train_file="${SAVE_MODEL_PATH}/${model_var}/Fold${i}/reranked_scores_noID.${model_var}.fold${i}.train.txt"
      save_score_val_file="${SAVE_MODEL_PATH}/${model_var}/Fold${i}/reranked_scores_noID.${model_var}.fold${i}.vali.txt"
      save_score_test_file="${SAVE_MODEL_PATH}/${model_var}/Fold${i}/reranked_scores_noID.${model_var}.fold${i}.test.txt"

      # java -jar RankLib.jar -load $best_model_file -rank $input_data_path -score $save_score_file
      java -jar RankLib.jar -load $best_model_file -rank $input_train_data_path -score $save_score_train_file
      java -jar RankLib.jar -load $best_model_file -rank $input_val_data_path -score $save_score_val_file
      java -jar RankLib.jar -load $best_model_file -rank $input_test_data_path -score $save_score_test_file
